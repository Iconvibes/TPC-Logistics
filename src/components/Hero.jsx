...
export default function Hero() {
  ...
  const handleSubmit = (event) => {
    ...
    if (!trimmed) return
    navigate(`/track?trackingId=${encodeURIComponent(trimmed)}`)
  }

  return (
    <section id="top" className="relative overflow-hidden bg-navy-900 pb-20 pt-16 lg:pb-28 lg:pt-24">
      <div className="absolute inset-0">
        <div className="absolute -left-32 top-16 h-80 w-80 rounded-full bg-cyber-600/20 blur-3xl animate-glow" />
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-8 animate-fade-up">
            ...
            <form
              ...
              className="rounded-3xl border border-slategray-700/40 bg-navy-800/60 p-4 shadow-glow"
            >
              <label
                htmlFor="hero-tracking"
                className="text-xs font-semibold uppercase tracking-[0.2em] text-slategray-300"
              >
                Track Your Shipment
              </label>
